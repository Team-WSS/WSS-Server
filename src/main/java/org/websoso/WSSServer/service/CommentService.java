...
import static org.websoso.WSSServer.exception.comment.CommentErrorCode.COMMENT_NOT_FOUND;
...
public class CommentService {
    ...
    public CommentsGetResponse getComments(User user, Feed feed) {
        ...
        for (Comment comment : feed.getComments()) {
            ...
            comments.add(CommentGetResponse.of(getUserInformation(createdUser), comment,
    ...
    private Comment getCommentOrException(Long commentId) {
        return commentRepository.findById(commentId).orElseThrow(() ->
                new InvalidCommentException(COMMENT_NOT_FOUND, "comment with the given id was not found"));
    }
